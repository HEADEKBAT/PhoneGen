...
import type { LearnArticle } from '@/lib/config/credentialLanding';
      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-16 sm:py-20">
        <div className="text-center mb-12">
          <h2 className="font-heading text-2xl sm:text-3xl font-bold text-foreground tracking-tight">
            {title || "Learn About Credential Security"}
          </h2>
          <p className="mt-2 text-sm text-muted-foreground max-w-md mx-auto">
            {subtitle || "Understand the fundamentals of secure credential generation"}
          </p>
        </div>
