...
export default function About() {
  ...
  const useCases = [
    { key: 'dev', gradient: 'from-primary/10 to-primary/5 border-primary/20' },
    { key: 'qa', gradient: 'from-accent/10 to-accent/5 border-accent/20' },
    { key: 'analyst', gradient: 'from-primary/10 to-primary/5 border-primary/20' },
    { key: 'edu', gradient: 'from-accent/10 to-accent/5 border-accent/20' },
  ] as const;
