...
export const ALL_GENERATORS = Object.values(GENERATORS).sort((a, b) => a.title.localeCompare(b.title));
/** Active generators (status = active or beta). */
export const ACTIVE_GENERATORS = ALL_GENERATORS.filter((g) => g.status === 'active' || g.status === 'beta');
/** Get generators for a specific product. */
export function getGeneratorsByProduct(productId) {
