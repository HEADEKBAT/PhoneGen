...
export const PRODUCTS: Record<string, Product> = {
  ...
  qr: {
    ...
    slug: 'qr-generator',
    title: 'QR Studio',
    description: 'Generate custom QR codes for URLs, Wi-Fi, vCard, email, social media, and 37+ data types. Free online QR code generator with designer, logo upload, and multiple export formats.',
    icon: 'QrCode',
    category: 'development',
    status: 'active',
    featured: true,
  ...
  payment: {
    id: 'payment',
    slug: 'payment-studio',
    title: 'Payment Studio',
    description: 'Generate test credit card numbers, validate cards, look up BINs, and create test payment profiles. Free online payment testing tools.',
    icon: 'CreditCard',
    category: 'finance',
    status: 'active',
    featured: true,
  ...
  creditCard: {
    ...
    description: 'Generate valid test credit card numbers for 15+ payment networks. Free online credit card generator with Luhn validation.',
    icon: 'CreditCard',
    category: 'finance',
    status: 'active',
    featured: false,
  ...
  cryptoWallet: {
    id: 'cryptoWallet',
    slug: 'crypto-wallet-playground',
    title: 'Crypto Wallet Playground',
    description: 'Generate, validate, analyze, and explore cryptocurrency wallet addresses for 22+ blockchains. Educational and professional Web3 testing tools.',
    icon: 'Wallet',
    category: 'development',
    status: 'active',
    featured: true,
  ...
  color: {
    ...
    title: 'Color Studio',
    description: 'Professional color toolkit — palettes, gradients, converters, accessibility checks, and developer exports.',
    icon: 'Palette',
    category: 'design',
    status: 'active',
    featured: true,
  ...
  image: {
    ...
    slug: 'image-studio',
    title: 'Image Studio',
    description: 'Remove backgrounds, enhance, upscale, and edit images. Free online image processing tools.',
    icon: 'Image',
    category: 'design',
    status: 'active',
    featured: true,
  ...
  media: {
    ...
    slug: 'media-studio',
    title: 'Media Studio',
    description: 'Convert, compress, resize, and edit video files. Free online media processing tools powered by FFmpeg.wasm — all in your browser.',
    icon: 'Video',
    category: 'development',
    status: 'active',
    featured: true,
