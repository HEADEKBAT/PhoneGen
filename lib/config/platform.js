...
export const PLATFORM_CONFIG = {
    ...
    description: 'GenCore helps developers, QA engineers, and testers generate realistic, valid test data. ' +
    ...
    seo: {
        ...
        defaultDescription: 'Generate realistic, valid test data for development and testing. ' +
            'Free platform with phone numbers, users, addresses, credentials, and more.',
        openGraph: {
            title: 'GenCore — Data Generation Platform',
            description: 'Generate realistic, valid test data for development and testing. ' +
        ...
        twitter: {
            card: 'summary',
            title: 'GenCore — Data Generation Platform',
            description: 'Generate realistic, valid test data for development and testing. Free platform with multiple generators.',
        },
    },
};
