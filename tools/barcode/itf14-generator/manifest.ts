...
export const itf14Generator = defineTool({
  ...
  seo: {
    meta: {
      ...
      es: { title: 'Generador ITF-14', description: 'Cree códigos de barras ITF-14. Generador gratuito.' },
      fr: { title: 'Générateur ITF-14', description: 'Créez des codes-barres ITF-14. Générateur gratuit.' },
      pt: { title: 'Gerador ITF-14', description: 'Crie códigos de barras ITF-14. Gerador gratuito.' },
    },
    faqs,
  },
