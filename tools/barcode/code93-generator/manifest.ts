...
export const code93Generator = defineTool({
  ...
  seo: {
    meta: {
      en: { title: 'Code 93 Generator', description: 'Generate Code 93 barcodes with higher density than Code 39. Free online Code 93 barcode generator with double check character security.', keywords: ['Code 93 generator', 'Code 93 barcode', 'compact barcode', 'industrial barcode'] },
      ...
      es: { title: 'Generador Code 93', description: 'Cree códigos de barras Code 93 compactos. Generador gratuito.' },
