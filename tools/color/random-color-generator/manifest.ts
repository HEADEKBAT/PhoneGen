...
export const randomColorGenerator = defineTool({
  ...
  seo: {
    meta: {
      en: { title: 'Random Color Generator', description: 'Generate random colors with hex, RGB, HSL values. Free online random color picker with lock and copy.', keywords: ['random color', 'hex color', 'color generator', 'random hex'] },
      ...
      es: { title: 'Generador de colores aleatorios', description: 'Genere colores aleatorios. Generador gratuito.' },
